...
if __name__ == "__main__":
    config = {
        ...
        "ocr":{
            ...
            "text_detection_model_name": "PP-OCRv5_mobile_det",     # 文本检测模型, 推荐 v5_mobile 速度更快，精度损失不大
            "text_recognition_model_name": "PP-OCRv5_server_rec",   # OCR识别模型, 推荐 v5_server 速度损失不多，但精度更高
